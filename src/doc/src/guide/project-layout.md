...
Payload uses conventions for file placement to make it easy to dive into a new
Payload [package][def-package]:
...
* `Payload.toml` and `Payload.lock` are stored in the root of your package (*package
  root*).
...
See [Target auto-discovery] for more information on controlling how Payload
...
[Configuring a target]: ../reference/payload-targets.md#configuring-a-target
[def-package]:           ../appendix/glossary.md#package          '"package" (glossary entry)'
[def-module]:            ../appendix/glossary.md#module           '"module" (glossary entry)'
[Target auto-discovery]: ../reference/payload-targets.md#target-auto-discovery
