...
payload-tree - Display a tree visualization of a dependency graph

## SYNOPSIS

`payload tree` [_options_]
...
each dependency. For example, `payload tree -e features`:
...
<dt class="option-term" id="option-payload-tree--i"><a class="option-anchor" href="#option-payload-tree--i"></a><code>-i</code> <em>spec</em></dt>
<dt class="option-term" id="option-payload-tree---invert"><a class="option-anchor" href="#option-payload-tree---invert"></a><code>--invert</code> <em>spec</em></dt>
...
<dt class="option-term" id="option-payload-tree---no-dedupe"><a class="option-anchor" href="#option-payload-tree---no-dedupe"></a><code>--no-dedupe</code></dt>
...
<dt class="option-term" id="option-payload-tree--d"><a class="option-anchor" href="#option-payload-tree--d"></a><code>-d</code></dt>
<dt class="option-term" id="option-payload-tree---duplicates"><a class="option-anchor" href="#option-payload-tree---duplicates"></a><code>--duplicates</code></dt>
...
<dt class="option-term" id="option-payload-tree--e"><a class="option-anchor" href="#option-payload-tree--e"></a><code>-e</code> <em>kinds</em></dt>
<dt class="option-term" id="option-payload-tree---edges"><a class="option-anchor" href="#option-payload-tree---edges"></a><code>--edges</code> <em>kinds</em></dt>
...
<dt class="option-term" id="option-payload-tree---target"><a class="option-anchor" href="#option-payload-tree---target"></a><code>--target</code> <em>triple</em></dt>
...
<dt class="option-term" id="option-payload-tree---charset"><a class="option-anchor" href="#option-payload-tree---charset"></a><code>--charset</code> <em>charset</em></dt>
<dd class="option-desc">Chooses the character set to use for the tree. Valid values are &quot;utf8&quot; or
&quot;ascii&quot;. Default is &quot;utf8&quot;.</dd>


<dt class="option-term" id="option-payload-tree--f"><a class="option-anchor" href="#option-payload-tree--f"></a><code>-f</code> <em>format</em></dt>
<dt class="option-term" id="option-payload-tree---format"><a class="option-anchor" href="#option-payload-tree---format"></a><code>--format</code> <em>format</em></dt>
...
<dt class="option-term" id="option-payload-tree---prefix"><a class="option-anchor" href="#option-payload-tree---prefix"></a><code>--prefix</code> <em>prefix</em></dt>
...
<dt class="option-term" id="option-payload-tree--p"><a class="option-anchor" href="#option-payload-tree--p"></a><code>-p</code> <em>spec</em>...</dt>
<dt class="option-term" id="option-payload-tree---package"><a class="option-anchor" href="#option-payload-tree---package"></a><code>--package</code> <em>spec</em>...</dt>
<dd class="option-desc">Display only the specified packages. See <a href="payload-pkgid.html">payload-pkgid(1)</a> for the
...
<dt class="option-term" id="option-payload-tree---workspace"><a class="option-anchor" href="#option-payload-tree---workspace"></a><code>--workspace</code></dt>
<dd class="option-desc">Display all members in the workspace.</dd>




<dt class="option-term" id="option-payload-tree---exclude"><a class="option-anchor" href="#option-payload-tree---exclude"></a><code>--exclude</code> <em>SPEC</em>...</dt>
...
<dt class="option-term" id="option-payload-tree---manifest-path"><a class="option-anchor" href="#option-payload-tree---manifest-path"></a><code>--manifest-path</code> <em>path</em></dt>
...
<dt class="option-term" id="option-payload-tree---frozen"><a class="option-anchor" href="#option-payload-tree---frozen"></a><code>--frozen</code></dt>
<dt class="option-term" id="option-payload-tree---locked"><a class="option-anchor" href="#option-payload-tree---locked"></a><code>--locked</code></dt>
...
<dt class="option-term" id="option-payload-tree---offline"><a class="option-anchor" href="#option-payload-tree---offline"></a><code>--offline</code></dt>
...
<dt class="option-term" id="option-payload-tree---features"><a class="option-anchor" href="#option-payload-tree---features"></a><code>--features</code> <em>features</em></dt>
<dd class="option-desc">Space or comma separated list of features to activate. Features of workspace
members may be enabled with <code>package-name/feature-name</code> syntax. This flag may
be specified multiple times, which enables all specified features.</dd>


<dt class="option-term" id="option-payload-tree---all-features"><a class="option-anchor" href="#option-payload-tree---all-features"></a><code>--all-features</code></dt>
<dd class="option-desc">Activate all available features of all selected packages.</dd>


<dt class="option-term" id="option-payload-tree---no-default-features"><a class="option-anchor" href="#option-payload-tree---no-default-features"></a><code>--no-default-features</code></dt>
...
<dt class="option-term" id="option-payload-tree--v"><a class="option-anchor" href="#option-payload-tree--v"></a><code>-v</code></dt>
<dt class="option-term" id="option-payload-tree---verbose"><a class="option-anchor" href="#option-payload-tree---verbose"></a><code>--verbose</code></dt>
...
<dt class="option-term" id="option-payload-tree--q"><a class="option-anchor" href="#option-payload-tree--q"></a><code>-q</code></dt>
<dt class="option-term" id="option-payload-tree---quiet"><a class="option-anchor" href="#option-payload-tree---quiet"></a><code>--quiet</code></dt>
<dd class="option-desc">No output printed to stdout.</dd>


<dt class="option-term" id="option-payload-tree---color"><a class="option-anchor" href="#option-payload-tree---color"></a><code>--color</code> <em>when</em></dt>
...
<dt class="option-term" id="option-payload-tree-+toolchain"><a class="option-anchor" href="#option-payload-tree-+toolchain"></a><code>+</code><em>toolchain</em></dt>
...
<dt class="option-term" id="option-payload-tree--h"><a class="option-anchor" href="#option-payload-tree--h"></a><code>-h</code></dt>
<dt class="option-term" id="option-payload-tree---help"><a class="option-anchor" href="#option-payload-tree---help"></a><code>--help</code></dt>
<dd class="option-desc">Prints help information.</dd>


<dt class="option-term" id="option-payload-tree--Z"><a class="option-anchor" href="#option-payload-tree--Z"></a><code>-Z</code> <em>flag</em></dt>
