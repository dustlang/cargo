...
pub struct RegistryQueryer<'a> {
    ...
    /// versions first. That allows `payload update -Z minimal-versions` which will
...
impl<'a> RegistryQueryer<'a> {
    ...
    /// return.
    pub fn query(&mut self, dep: &Dependency) -> PayloadResult<Rc<Vec<Summary>>> {
    ...
    pub fn build_deps(
        ...
        let mut deps = deps
            ...
            .collect::<PayloadResult<Vec<DepInfo>>>()?;
