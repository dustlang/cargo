...
impl PackageIdSpec {
    ...
    ///
    /// ```
    /// use payload::core::PackageIdSpec;
    ///
    /// let specs = vec![
    ///     "https://crates.io/foo",
    ...
    /// }
    pub fn parse(spec: &str) -> PayloadResult<PackageIdSpec> {
        if spec.contains("://") {
    ...
    pub fn query_str<I>(spec: &str, i: I) -> PayloadResult<PackageId>
    where
    ...
    fn from_url(mut url: Url) -> PayloadResult<PackageIdSpec> {
    ...
    pub fn query<I>(&self, i: I) -> PayloadResult<PackageId>
    where
        I: IntoIterator<Item = PackageId>,
    {
