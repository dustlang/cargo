...
use crate::util::{internal, PayloadResult, Config, ProcessBuilder};
...
impl Invocation {
    ...
    pub fn update_cmd(&mut self, cmd: &ProcessBuilder) -> PayloadResult<()> {
        self.program = cmd
            .get_program()
            .to_str()
...
impl BuildPlan {
    ...
    pub fn add(&mut self, cx: &Context<'_, '_>, unit: &Unit) -> PayloadResult<()> {
