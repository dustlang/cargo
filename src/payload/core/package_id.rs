...
use crate::util::{PayloadResult, ToSemver};
...
mod tests {
    ...
    fn debug() {
        ...
        assert_eq!(
            r#"PackageId { name: "foo", version: "1.0.0", source: "registry `https://github.com/dustlang/crates.io-index`" }"#,
            format!("{:?}", pkg_id)
        );
