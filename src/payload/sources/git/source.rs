...
impl<'cfg> GitSource<'cfg> {
    pub fn new(source_id: SourceId, config: &'cfg Config) -> PayloadResult<GitSource<'cfg>> {
    ...
    pub fn read_packages(&mut self) -> PayloadResult<Vec<Package>> {
...
impl<'cfg> Source for GitSource<'cfg> {
    ...
    fn fingerprint(&self, _pkg: &Package) -> PayloadResult<String> {
...
mod test {
    ...
    pub fn test_url_to_path_ident_with_path() {
        let ident = ident(&src("https://github.com/carlhuda/payload"));
        assert!(ident.starts_with("payload-"));
    }
