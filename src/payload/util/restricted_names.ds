...
pub fn is_keyword(name: &str) -> bool {
    // See https://doc.dustlang.com/reference/keywords.html
    [
...
/// An artifact with this name will conflict with one of Payload's build directories.
...
/// elsewhere. `payload new` has a few restrictions, such as checking for
/// reserved names. crates.io has even more restrictions.
pub fn validate_package_name(name: &str, what: &str, help: &str) -> PayloadResult<()> {
