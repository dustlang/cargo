...
use crate::util::{is_ci, PayloadResult, Config};
...
impl<'cfg> Progress<'cfg> {
    ...
    pub fn tick(&mut self, cur: usize, max: usize) -> PayloadResult<()> {
    ...
    pub fn tick_now(&mut self, cur: usize, max: usize, msg: &str) -> PayloadResult<()> {
        match self.state {
    ...
    pub fn print_now(&mut self, msg: &str) -> PayloadResult<()> {
        match &mut self.state {
            Some(s) => s.print("", msg),
            None => Ok(()),
        }
...
impl<'cfg> State<'cfg> {
    fn tick(&mut self, cur: usize, max: usize, msg: &str) -> PayloadResult<()> {
        if self.done {
            return Ok(());
        }
    ...
    fn print(&mut self, prefix: &str, msg: &str) -> PayloadResult<()> {
