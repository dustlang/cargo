...
pub fn clean(ws: &Workspace<'_>, opts: &CleanOptions<'_>) -> PayloadResult<()> {
                ...
                for (compile_kind, layout) in &layouts {
                    ...
                    for file_type in file_types {
                        ...
                        if let Some(uplift_dir) = uplift_dir {
                            ...
                            // Dep-info generated by Payload itself.
...
fn rm_rf_glob(pattern: &Path, config: &Config) -> PayloadResult<()> {
...
fn rm_rf(path: &Path, config: &Config) -> PayloadResult<()> {
