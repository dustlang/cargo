...
pub fn generate_lockfile(ws: &Workspace<'_>) -> PayloadResult<()> {
...
pub fn update_lockfile(ws: &Workspace<'_>, opts: &UpdateOptions<'_>) -> PayloadResult<()> {
    ...
    // that we're synchronized against other Payloads.
