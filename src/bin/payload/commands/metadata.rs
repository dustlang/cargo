...
use payload::ops::{self, OutputMetadataOptions};
...
pub fn cli() -> App {
    subcommand("metadata")
        ...
        .arg(opt("quiet", "Do not print payload log messages").short("q"))
        .arg_features()
        .arg(multi_opt(
            "filter-platform",
            "TRIPLE",
        ...
        .after_help("Run `payload help metadata` for more detailed information.\n")
}
