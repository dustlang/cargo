...
use anyhow::bail;
use payload::{drop_println, PayloadResult};
use serde::Serialize;

pub fn cli() -> App {
    subcommand("locate-project")
        .about("Print a JSON representation of a Payload.toml file's location")
        ...
        .arg(opt("workspace", "Locate Payload.toml of the workspace root"))
        .after_help("Run `payload help locate-project` for more detailed information.\n")
}
...
impl MessageFormat {
    fn parse(args: &ArgMatches<'_>) -> PayloadResult<Self> {
