...
use payload::ops::{self, CleanOptions};
use payload::util::print_available_packages;

pub fn cli() -> App {
    subcommand("clean")
        .about("Remove artifacts that payload has generated in the past")
        ...
        .after_help("Run `payload help clean` for more detailed information.\n")
}
