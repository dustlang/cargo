...
use payload::core::{GitReference, SourceId};
use payload::ops;
use payload::util::IntoUrl;

pub fn cli() -> App {
    subcommand("install")
        .about("Install a Rust binary. Default location is $HOME/.payload/bin")
        ...
        .after_help("Run `payload help install` for more detailed information.\n")
}
