...
use payload::ops::{self, CompileFilter, FilterRule, LibRule};
...
pub fn cli() -> App {
    subcommand("fix")
        ...
        .after_help("Run `payload help fix` for more detailed information.\n")
}
...
pub fn exec(config: &mut Config, args: &ArgMatches<'_>) -> CliResult {
    ...
    // Unlike other commands default `payload fix` to all targets to fix as much
    // code as we can.
