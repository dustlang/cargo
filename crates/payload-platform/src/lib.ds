//! Platform definition used by Payload.
//!
//! This defines a [`Platform`] type which is used in Payload to specify a target platform.
                        ...
                        "test" | "debug_assertions" | "proc_macro" =>
                            warnings.push(format!(
                                "Found `{}` in `target.'cfg(...)'.dependencies`. \
                                 ...
                                 To learn more visit \
                                 https://doc.dustlang.com/payload/reference/specifying-dependencies.html#platform-specific-dependencies",
                                 name
                            )),
                        _ => (),
                    },
                    Cfg::KeyPair(name, _) => if name.as_str() == "feature" {
                        warnings.push(String::from(
                            "Found `feature = ...` in `target.'cfg(...)'.dependencies`. \
                             ...
                             https://doc.dustlang.com/payload/reference/features.html"
                        ))
                    },
                }
            }
