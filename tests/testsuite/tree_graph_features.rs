//! Tests for the `payload tree` command with -e features option.
...
",
    ...
    p.payload("tree -e features -i a -i b")
        .with_stdout(
            "\
a v0.1.0 ([..]/foo/a)
├── a feature \"a1\"
...
fn slash_feature_name() {
    ...
    p.payload("tree -e features --features f1")
        .with_stdout(
            "\
foo v0.1.0 ([..]/foo)
...
",
    ...
    p.payload("tree -e features --features f1 -i foo")
        .with_stdout(
            "\
foo v0.1.0 ([..]/foo)
...
",
    ...
    p.payload("tree -e features --features f1 -i notopt")
        .with_stdout(
            "\
notopt v1.0.0
...
",
    ...
    p.payload("tree -e features --features notopt/animal -i notopt")
        .with_stdout(
            "\
notopt v1.0.0
...
",
    ...
    p.payload("tree -e features --all-features")
        .with_stdout(
            "\
foo v0.1.0 ([..]/foo)
├── notopt feature \"default\"
...
",
    ...
    p.payload("tree -e features --all-features -i opt2")
        .with_stdout(
            "\
opt2 v1.0.0
└── opt2 feature \"default\"
...
",
        ...
        .run();
    p.payload("tree -e features --all-features --target=all")
        .with_stdout(
            "\
foo v0.1.0 ([..]/foo)
